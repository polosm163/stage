...
$(function () {
    ...
    var uusername1;
    LoginUtil.sendAjax("/sys/home/",null,null,null,null,function (res) {
                    ...
                    if(item.children != null && item.children.length > 0){
                        ...
                        $.each(item.children,function(index,child){
                            if(child.children !=null&& child.children.length>0){
                                ...
                                ulHtml += '<dd><a href="javascript:;" data-url="'+CoreUtil.ctx+child.url+'" data-title="'+child.title+'" data-id="'+child.id+'" class="menuNvaBar">';
                                if(child.icon != undefined && child.icon != ''){
                                    ulHtml += '<i class="layui-icon '+child.icon+'" style="padding-right: 8px; font-size: 16px" "'+child.icon+'"></i>';
                                }
