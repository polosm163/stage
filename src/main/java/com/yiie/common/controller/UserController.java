...
public class UserController {
    ...
    public DataResult<LoginRespVO> login(@RequestBody(required=false) String data,HttpServletRequest request){
        log.info(Utility.getParamAsMap(request).toString());
    ...
    @GetMapping("/sys/user/roles/{userId}")
    ...
    @PutMapping("/sys/user/roles/{userId}")
